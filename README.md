...
| `interactive` | bool | `True` | Save interactive HTML versions of `DataPlots` and `Diagnostics` alongside the PDF/PNG. Open in any browser — hover over data points to see their values, zoom and pan freely |
