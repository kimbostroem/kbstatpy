...
write.csv(tg, "demos/data/toothgrowth.csv", row.names = FALSE)
...
write.csv(es, "demos/data/ergostool.csv", row.names = FALSE)
...
write.csv(ss, "demos/data/sleepstudy.csv", row.names = FALSE)
...
oats$nitro <- NULL
write.csv(oats, "demos/data/oats.csv", row.names = FALSE)
...
write.csv(mtcars, "demos/data/mtcars.csv", row.names = TRUE)
...
write.csv(longley, "demos/data/longley.csv", row.names = FALSE)
...
write.csv(stackloss, "demos/data/stackloss.csv", row.names = FALSE)
...
write.csv(bact, "demos/data/bacteria.csv", row.names = FALSE)
cat("Exported bacteria.csv\n")

cat("\nDone. All datasets written to demos/data/\n")
