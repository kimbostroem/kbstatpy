...
# --- Demo 8: npk (LMM with partial interaction) ---
...
# --- Demos 9 & 10: iris (multi-y GLMM + correlation) ---
...
# --- Demos 10 & 11: mtcars (correlation + VIF with mixed predictors) ---
...
# --- Demo 10: longley (standalone correlation) ---
