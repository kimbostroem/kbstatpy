"""Demo 8: LMM with a partial interaction (three fixed-effect factors, one interaction).
...
This contrasts with demo 6 (oats), where all pairwise terms from a two-factor
